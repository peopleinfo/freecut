...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          <strong>Brave users:</strong> The File System Access API is disabled
          by default. To enable it, navigate to{" "}
  ...
  },
  {
    ...
    answer:
      "Video: MP4, MOV, WebM, MKV. Audio: MP3, AAC, WAV. Multiple codecs (H.264, H.265, VP8, VP9) and quality settings available.",
  },
  {
    question: "Future Improvements",
    answer:
      "Will add features as I see fit and based on feedback. Maybe come up with a roadmap or something.",
  },
  {
    ...
    answer: (
      <>
        <p className="mb-3">
          ...
          for making browser-based video encoding easy. This project wouldn't
      ...
      <section className="relative flex min-h-[60vh] flex-col items-center justify-center px-6 py-12">
        ...
        <div className="relative z-10 flex flex-col items-center text-center animate-fade-in">
          ...
          <p className="mb-6 max-w-lg text-lg text-muted-foreground sm:text-xl">
            Professional video editing, zero installation. Create stunning
            content in your browser.
          </p>

          <p className="mb-6 max-w-lg text-sm text-amber-600 dark:text-amber-500">
            ⚠️ DISCLAIMER: This is very much in beta and might be buggy. I hope
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-4 md:grid-cols-3 md:grid-rows-2">
            {showcaseItems.map((item) => (
              ...
              >
                <div
                  className={`relative ${item.aspectClass} w-full overflow-hidden bg-muted`}
                >
                  {item.media ? (
                    <img
                      src={item.media}
